...
(function (LCC) {
    ...
    (function (Services) {
        var SharePoint = (function () {
            ...
            SharePoint.ExecuteSearchQuery = function (searchQuery) {
            ...
            SharePoint.GetRelatedPagesKQLString = function (pageTerms) {
                var output = "(";
            ...
            SharePoint.GetRelatedPages = function (pageCats) {
                var dfd = jQuery.Deferred();
            ...
            SharePoint.GetCurrentPageSPItem = function () {
                var dfd = jQuery.Deferred();
                var listId = _spPageContextInfo.pageListId.slice(1, -1);
            ...
            SharePoint.GetPageRelatedTerms = function (listItem) {
            ...
            SharePoint.SplitPageCatgoryTerms = function (pageCatString) {
                var cats = [];
            ...
            SharePoint.GetTerm = function (item) {
                var dfd = jQuery.Deferred();
                var thisitem = item;
            ...
            SharePoint.GetTermSetOfTerm = function (data) {
                var thisdata = data;
                var dfd = jQuery.Deferred();
                var context = SP.ClientContext.get_current();
                var session = SP.Taxonomy.TaxonomySession.getTaxonomySession(context);
    ...
    })(Services = LCC.Services || (LCC.Services = {}));
})(LCC || (LCC = {}));
